...
function play(delta){
    ...
    contain(slime, {x: 16, y:  88 + 16, width: app.renderer.width, height: app.renderer.height - 88 });
    contain(enemySlime, {x: 16, y:  88 + 16, width: app.renderer.width, height: app.renderer.height - 88 });
